// Fallback when Supabase is not configured or fetch fails
const FALLBACK_WORK_EXPERIENCE = [
  {
    id: 'uavsberkeley',
    org: 'UAVs@Berkeley',
    logo: 'uavs.png',
    position: 'EE Subteam Member',
    description:
      'I create PCB schematics in Altium Designer for unmanned aerial vehicle systems such as drones and VTOLs!',
    details: `At UAVs@Berkeley, I work on power converter boards, sensor integration, and PCB layout for unmanned aerial vehicle avionics systems. I collaborate with subteams and use Altium Designer to create production-ready PCBs that power cutting-edge drone technology.
...
My responsibilities include designing circuit schematics, performing component selection, and ensuring designs meet industry standards for reliability and performance. I work closely with mechanical and software teams to integrate electronic systems seamlessly into our aircraft designs.`,
  },
  {
    ...
    details: `During my internship at Boeing's EPSTE (Electronic Products Special Test Equipment) department, I gained hands-on experience in aerospace electronics and test equipment systems. I created detailed wire diagrams and thermocouple setups for testing rack systems used in flight test equipment validation.
...
export default FALLBACK_WORK_EXPERIENCE;
